...
class SmartPgxApiModel {
  ...
  factory SmartPgxApiModel.fromRawJson(String str) => SmartPgxApiModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory SmartPgxApiModel.fromJson(Map<String, dynamic> json) => SmartPgxApiModel(
